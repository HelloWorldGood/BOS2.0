...
public class MailUtils {
	...
	private static String username = "yanglei_search@163.com"; // 邮箱账户
	private static String password = "itcast123"; // 邮箱授权码

	private static String from = "yanglei_search@163.com"; // 使用当前账户
	...
	public static void main(String[] args) {
		sendMail("测试邮件111", "你好，杨磊", "yanglei_search@163.com");
	}
}
